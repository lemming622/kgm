...
public class Utility
{
  ...
  /**
   * Check if this folder has sub-directories.
   * @param path a folder
   * @return true if this folder has sub-directories
   */
  public static boolean hasDirectories(String path)
  {
   ...
   * @param name the name to give the file (can be null)
